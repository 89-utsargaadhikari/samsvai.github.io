...
app.post('/add-product', (req, res) => {
    ...
    if(!draft){
        if (!name.length) {
            res.json({ 'alert': 'should enter the prodcut name' })
            ...
            res.json({ 'alert': 'must enter the product details' });
        } else if (!tags.length) {
...
app.get('/black-tea', (req, res) => {
    res.sendFile("black.html", { root: "public" });
})
app.get('/green-tea', (req, res) => {
    res.sendFile("green.html", { root: "public" });
})
app.get('/white-tea', (req, res) => {
    res.sendFile("white.html", { root: "public" });
})
app.get('/olong-tea', (req, res) => {
    res.sendFile("olong.html", { root: "public" });
})
